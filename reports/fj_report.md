    ...
    ------------------------------------------------------------
    SECURE (ACTIVE/PASSIVE):     3 (15.0%) -> Protects 27.3% of Traffic
    VULNERABLE NETWORKS:        10 (50.0%) -> Exposes  54.5% of Traffic
    ...
    AS4638   | Unverified (Transit/Peer?)     | 2        | 65%    | Telecom Fiji Limited
    ...
    #6   | AS4648   | 2          | REGRESSED                      | Spark New Zealand
    #7   | AS7575   | 2          | ACTIVE LOCAL ROV               | Australian Academic and Research Network
    #8   | AS38442  | 2          | REGRESSED                      | Vodafone Fiji Limited
