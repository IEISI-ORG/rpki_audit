    ...
    ----------------------------------------------------------------------------------------------------
    AS17993  | PARTIAL: VULNERABLE (Mixed)    | 1        | 99%    | Vodafone Samoa Limited
    AS9218   | NOT ROUTED                     | 0        | -      | WISEVAN GUARD Limited
    AS38227  | NOT ROUTED                     | 0        | -      | Computer Services Limited (CSL)
    AS38800  | STUB: UNRELIABLE               | 0        | 100%   | Digicel Samoa Ltd
    ...
    #6   | AS38800  | 1          | STUB: UNRELIABLE               | Digicel Samoa Ltd
    #7   | AS132528 | 1          | PARTIAL: VULNERABLE (Mixed)    | DIGICEL (AUS) PTY LTD
    #8   | AS18400  | 1          | VULNERABLE                     | Xtreme Networks Limited
