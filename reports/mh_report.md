    ...
    ------------------------------------------------------------
    SECURE (ACTIVE/PASSIVE):     4 (36.4%) -> Protects 100.0% of Traffic
    ...
    ----------------------------------------------------------------------------------------------------
    AS154410 | PASSIVE (Clean Pipe)           | 6        | -      | Marshall Telecom Ltd
    AS24439  | STUB: FORTUITOUS ROV           | 0        | 99%    | MARSHALL ISLANDS NTA ISP AS
    AS50183  | STUB: VULNERABLE               | 0        | -      | CenturyNetworks Ltd
    ...
    ----------------------------------------------------------------------------------------------------
    #1   | AS6453   | 2          | CORE: ACTIVE PROTECTOR         | TATA Communications (America) Inc
    #2   | AS3257   | 2          | CORE: ACTIVE PROTECTOR         | GTT Communications Inc.
    #3   | AS1299   | 2          | CORE: ACTIVE PROTECTOR         | Arelion (fka. Telia Carrier)
